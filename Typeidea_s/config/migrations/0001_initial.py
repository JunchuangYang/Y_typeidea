# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2020-02-29 14:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='标题')),
                ('display_type', models.PositiveIntegerField(choices=[(4, '最近评论'), (3, '最热文章'), (1, 'HTML'), (2, '最新文章')], default=1, verbose_name='展示类型')),
                ('content', models.CharField(blank=True, help_text='如果设置的不是HTML内容，可为空', max_length=500, verbose_name='内容')),
